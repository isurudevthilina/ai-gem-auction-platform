                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                                    <div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginTop: 4 }}>
                                            <p style={{ margin: 0, fontSize: '0.72rem', color: T.muted, fontFamily: BODY }}>
                                                Defaults to the current system time. You can edit it manually.
                                            </p>
                                            <button
                                                type="button"
                                                onClick={() => set('start_time', localISOString(0))}
                                                style={{
                                                    border: 'none',
