...
import { ChevronLeft, ChevronRight, RotateCcw, Sparkles, TrendingUp, Info, ArrowRight } from 'lucide-react';
...
const ResultScreen = ({ result, formData, onReset, onListGem, userRole }) => {
    const gem = GEM_FAMILIES.find(g => g.name === formData.gemFamily);
