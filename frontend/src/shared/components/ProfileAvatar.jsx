...
import { LogOut, User, LayoutDashboard, Heart, Gavel, GemIcon, ListPlus, ShieldCheck, ShoppingBag, BarChart3, Star, Wallet } from 'lucide-react';
...
const getMenuItems = (role, userId) => {
    ...
    if (role === 'buyer') {
        items.push(
            ...
            { label: 'Reviews & Ratings', to: '/transactions', icon: Star },
            { label: 'Wallet Top-Up', to: '/wallet/top-up', icon: Wallet },
            { label: 'Withdraw', to: '/wallet/withdraw', icon: Wallet },
            { label: 'Gem Store', to: '/wallet/gem-store', icon: GemIcon },
        );
    } else if (role === 'seller') {
        items.push(
            ...
            { label: 'Purchases & Reviews', to: '/transactions', icon: ShoppingBag },
            { label: 'Watchlist', to: '/watchlist', icon: Heart },
